...
__PYX_EXTERN_C PyObject *str_add(PyObject *, PyObject *); /*proto*/
...
PyObject *str_add(PyObject *__pyx_v_str1, PyObject *__pyx_v_str2) {
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyNumber_Int(__pyx_v_str1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyNumber_Int(__pyx_v_str2); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 2, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("run.str_add", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
